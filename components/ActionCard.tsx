      ...
      <View style={[styles.card, styles.elevatedCard]}>
        ...
        <View style={styles.bodyContainer}>
          <Text numberOfLines={3}>
            ...
            JavaScript, enhancing the language's capabilities. Notable additions
            include the 'Logical Assignment Operators' for concise variable
            updates, 'String.prototype.replaceAll()' for global string
            replacement, and the 'Promise.any()' method for handling
        ...
        <View style={styles.footerContainer}>
          ...
          <TouchableOpacity onPress={()=> openWebsite('https://www.linkedin.com/in/mohd-saif-134076141/')}>
